...
TEST(PwlTest, TestArithmetic) {
    ...
    EXPECT_TRUE(near((S * PiecewiseLinearFunction::createConstant(3.0))(4.0), 12.0)) << "multiply by constant";
    EXPECT_TRUE(near((S / PiecewiseLinearFunction::createConstant(2.0))(6.0),  3.0)) << "divide by constant";
