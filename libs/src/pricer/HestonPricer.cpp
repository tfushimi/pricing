...
double HestonPricer::visit(const CashPayment& node) {
...
double HestonPricer::priceSegment(const Segment& segment, const double dF,
    ...
    // Under Heston, S >= 0 always — trim segment to non-negative domain
