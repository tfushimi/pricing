...
TEST(ConstantFoldVisitorTest, MultiplyTest) {
...

    {
        ...
        const auto* fixing = asFixing(visitor.evaluate(mult));
...
TEST(ConstantFoldVisitorTest, GreaterThanTest) {
    ...
    const auto* greaterThanConstant = asConstant(visitor.evaluate(greaterThan));
    ...
    const auto* greaterThanOrEqualConstant = asConstant(visitor.evaluate(greaterThanOrEqual));
...
TEST(ConstantFoldVisitorTest, IfThenElseTest) {
    {
        ...
        const auto* ifThenElseConstant = asConstant(visitor.evaluate(ifThenElse));
